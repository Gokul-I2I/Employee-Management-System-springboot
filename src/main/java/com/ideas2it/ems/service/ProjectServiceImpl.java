...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectDto deleteProject(int id) {
        ...
        if (project == null) {
            ...
            throw new ResourceNotFound("Project not found : " + id);
    ...
    public ProjectDto updateProject(ProjectDto projectDto) {
        ...
        if (project == null) {
            ...
            throw new ResourceNotFound("Project not found :" + projectDto.getId());
        }
    ...
    public List<EmployeeDto> retrieveEmployeesByProjectId(int id) {
        ...
        if (employeeDtos.isEmpty()) {
            ...
            throw new ResourceNotFound("Employees not found in project id : " + id);
        }
        return employeeDtos;
    }
    ...
    public List<ProjectDto> retrieveProjects() {
        ...
        if (projects.isEmpty()) {
            LOGGER.warn("Project Not Found ");
            throw new ResourceNotFound("No Projects Available");
        }
    ...
    public ProjectDto addProjectToEmployee(@PathVariable int employeeId, @PathVariable int projectId) {
        ...
        if (employee == null) {
            ...
            throw new ResourceNotFound("Employees not found in project id : " + employeeId);
        }
